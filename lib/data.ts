...
export const studyRoutes: SidebarType[] = [
  ...
  },
  {
    label: 'Database',
    href: '/study/database',
    description: 'A quick reference for Database Setup',
  },
  {
    label: 'CRUD',
...
export const products: ProductType[] = [
  {
    ...
    title: 'Apple',
    price: 5,
    description: 'Apple is a fruit that is red and round',
  },
  {
    id: '2',
    title: 'Banana',
  ...
  },
  {
    ...
    title: 'Cherry',
    price: 3,
    description: 'Cherry is a fruit that is red and round',
  },
  {
    id: '4',
    title: 'Date',
    price: 4,
    description: 'Date is a fruit that is brown and round',
  },
  {
    id: '5',
    title: 'Elderberry',
  ...
  },
  {
    ...
    title: 'Fig',
    price: 6,
    description: 'Fig is a fruit that is brown and round',
  },
  {
    id: '7',
    title: 'Grape',
    price: 7,
    description: 'Grape is a fruit that is purple and round',
  },
  {
    id: '8',
    title: 'Honeydew',
  ...
  },
  {
    ...
    title: 'Kiwi',
    price: 9,
    description: 'Kiwi is a fruit that is brown and round',
  },
  {
    id: '10',
    title: 'Lemon',
...
export const overviewData = [
  ...
  },
  {
    ...
    week: 8,
    topic: 'CRUD 写入',
    criteria: 'Create / Update / Delete 全独立写',
  },
  {
    phase: '核心',
    week: 9,
  ...
  },
  {
    ...
    week: 12,
    topic: '项目一：规划+骨架',
    criteria: '数据模型 + auth + 列表页',
  },
  {
    phase: '里程碑',
    week: 13,
    topic: '项目一：功能完善',
    criteria: '完整 CRUD + 校验 + 隔离',
  },
  {
    phase: '里程碑',
    week: 14,
    topic: '项目一：打磨上线',
    criteria: 'shadcn/ui + 部署 Vercel',
  },
  {
    phase: '进阶',
    week: 15,
    topic: 'Stripe 支付',
    criteria: 'checkout + webhook 跑通',
  },
  {
    phase: '进阶',
    week: 16,
    topic: 'OpenAI API',
    criteria: 'chat + streaming 跑通',
  },
  {
    phase: '里程碑',
    week: 17,
    topic: '项目二：规划+骨架',
    criteria: '产品定义 + auth + 主页面',
  },
  {
    phase: '里程碑',
    week: 18,
...
export const weeklyData = [
  ...
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 2',
        content: '受控表单基础，useState 管理多字段 + onSubmit',
      },
      {
        day: 'Day 3',
      ...
      {
        day: 'Day 4',
        content: '给 /contact 做完整联系表单 + 错误提示',
      },
      {
        day: 'Day 5',
        content: '默写验收： 默写带校验的登录表单',
        isMock: true,
      },
    ],
  },
  ...
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 5',
        content: '默写验收： 60分钟从零写一张表的完整 CRUD 全套',
        isMock: true,
      },
    ],
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 5',
        content: '默写验收： 60分钟写带关联表 + 错误回显的 CRUD',
        isMock: true,
      },
    ],
  },
  ...
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 2',
        content: '项目初始化 + Drizzle schema + 数据库 migrate。',
      },
      {
        day: 'Day 3',
        content: '接入 Better Auth（注册 + 登录 + 保护路由）。',
      },
      { day: 'Day 4', content: '主列表页，读出当前用户的任务。' },
      {
        day: 'Day 5',
        content: '验收： 周回顾，对照需求清单看进度，记录卡点。',
        isMock: true,
      },
    ],
  },
  ...
  },
  {
    ...
    days: [
      {
        day: 'Day 1',
        content: '用 shadcn/ui 美化（Button, Card, Dialog, Input）。',
      },
      {
        day: 'Day 2',
        content: '处理 loading / error / empty 三种状态。',
      },
      {
        day: 'Day 3',
        content: 'Tailwind 响应式，确保手机端能完美浏览。',
      },
  ...
  },
  {
    ...
    days: [
      {
        day: 'Day 1',
        content: '理论：Stripe 概念，test mode 注册配置。',
      },
      {
        day: 'Day 2',
  ...
  },
  {
    ...
    days: [
      {
        day: 'Day 1',
        content: '理论：API key、token、模型概念，拿 key 配置。',
      },
      {
        day: 'Day 2',
  ...
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 2',
        content: '初始化 + schema + Better Auth 接入。',
      },
      {
        day: 'Day 3',
      ...
      {
        day: 'Day 4',
        content: '主功能列表页（读取当前用户的 AI 生成历史记录）。',
      },
      {
        day: 'Day 5',
        content: '验收： 周回顾 + 进度严格核对。',
        isMock: true,
      },
    ],
  },
  {
    ...
    days: [
      {
        day: 'Day 1',
        content: '生成记录 Create（表单提交 → 存库）。',
      },
      {
        day: 'Day 2',
        content: 'Update / Delete 记录功能 + 表单校验与错误回显。',
      },
      {
        day: 'Day 3',
  ...
  },
  {
    ...
    days: [
      {
        day: 'Day 1',
        content: '理论：Stripe 订阅模型学习，设计价格档位（Plan）。',
      },
      {
        day: 'Day 2',
      ...
      {
        day: 'Day 3',
        content: '编写 webhook 更新用户订阅状态并安全写入数据库。',
      },
      {
        day: 'Day 4',
        content: '按订阅状态做门控逻辑（付费用户解锁配额限制）。',
      },
      {
        day: 'Day 5',
        content: '验收： 用测试信用卡完整走通订阅全流程。',
        isMock: true,
      },
    ],
  },
  {
    ...
    days: [
      ...
      {
        day: 'Day 4',
        content: '上线部署 + 绑定自定义域名 + 严格检查生产环境变量。',
      },
      {
        day: 'Day 5',
